...
import com.dog.childgrowthmonitor.util.FILTER_PARENT_BY
import com.dog.childgrowthmonitor.util.SEARCH_IN
import com.dog.childgrowthmonitor.util.hideKeyboard
import kotlinx.android.synthetic.main.app_search.view.*
import java.util.*
import kotlin.collections.ArrayList

class SearchFragmentMother : Fragment() {
    ...
    override fun onCreateView(
        ...
        val factory = SearchMotherViewModelFactory(
            context!!,
            searchIn!!,
            filterBy
        )
        val viewModel = ViewModelProvider(this, factory)[SearchMotherViewModel::class.java]
        ...
        root.search.setOnSuggestionListener(object : SearchView.OnSuggestionListener{
            ...
            override fun onSuggestionClick(position: Int): Boolean {
                ...
                val idChild = listOfSuggestions.indexOf(selection)
                viewModel.setId(listOfId[idChild])
                root.search.setQuery("", false)
